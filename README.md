# Starter Kit for [Building Applications in React and Redux in ES6].https://github.com/vivek4you11/Trending-Tech.git

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/vivek4you11/Trending-Tech.git` or [download the zip](https://github.com/vivek4you11/Trending-Tech/archive/master.zip)
3. **Make sure you're in the directory you just created.** - `cd Trending-Tech`
